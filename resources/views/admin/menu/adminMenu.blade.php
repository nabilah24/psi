                ...
                <tbody class="text-center">
                    @foreach ($menus as $menu)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('adminMenu.show', $menu->id) }}" class="btn btn-info">Detail</a>
                                <a href="{{ route('adminMenu.edit', $menu->id) }}" class="btn btn-warning">Edit</a>
                                <button onclick="handleDelete({{ $menu->id }})" class="btn btn-danger">Hapus</button>
                            </td>
                        </tr>
                    @endforeach
                    @empty($menus)
